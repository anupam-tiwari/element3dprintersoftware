...
namespace MatterHackers.MatterControl
{
	public class SavePartsSheetFeedbackWindow : SystemWindow
	{
			...
			: this(300.0, 500.0)
		{
			...
			string arg2 = "Saving to Parts Sheet".Localize();
		...
		public void StartingNextPart(object sender, EventArgs e)
		{
			...
			if (val != null)
			{
				string startText = $"{count}/{totalParts} '{val.get_Data()}'";
				((GuiWidget)feedback).AddChild((GuiWidget)(object)CreateNextLine(startText), -1);
			}
		}
		...
		public void DoneSaving(object sender, EventArgs e)
		{
			...
			if (val != null)
			{
				((GuiWidget)feedback).AddChild((GuiWidget)(object)CreateNextLine($"{val.get_Data()}"), -1);
			}
		}
	}
}
