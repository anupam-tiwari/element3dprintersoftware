...
namespace MatterHackers.MatterControl
{
	public class DoubleSolidSlideView
	{
		...
		public DoubleSolidSlideView(DoubleSolidSlider sliderWidget)
		{
			...
			sliderWidget.FirstValueChanged += sliderWidget_ValueChanged;
			sliderWidget.SecondValueChanged += sliderWidget_ValueChanged;
		}
		...
		{
			//IL_0006: Unknown result type (might be due to invalid IL or missing references)
			return sliderAttachedTo.GetFirstThumbHitBounds();
		}
		...
		public void DoDrawAfterChildren(Graphics2D graphics2D)
		{
			...
			RoundedRect val2 = new RoundedRect(sliderAttachedTo.GetFirstThumbHitBounds(), 0.0);
			...
			RoundedRect val4 = new RoundedRect(sliderAttachedTo.GetSecondThumbHitBounds(), 0.0);
			thumbColor = ThumbColor;
			RGBA_Floats asRGBA_Floats2 = ((RGBA_Bytes)(ref thumbColor)).GetAsRGBA_Floats();
			val3 = RGBA_Floats.Black;
			val3 = RGBA_Floats.GetTweenColor(asRGBA_Floats2, ((RGBA_Floats)(ref val3)).GetAsRGBA_Floats(), 0.2);
			graphics2D.Render((IVertexSource)(object)val4, (IColorType)(object)((RGBA_Floats)(ref val3)).GetAsRGBA_Bytes());
		}
	}
}
